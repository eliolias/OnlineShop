...
public class topUtils {
    ...
    public static TShirt greenTShirt = new TShirt("Green T-Shirt", 11111, 8.99, top, Sizes.M, "Green", "Dress Tshirt");
    public static TShirt brownTShirt = new TShirt("Brown T-Shirt", 11112, 8.99, top, Sizes.L, "Brown", "plain Tshirt");
